  ...
  return (
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <a href="https://www.instagram.com/srisaichaitanya_jr_college_mpl/" target="_blank" rel="noopener noreferrer" style={{ color: 'white', textDecoration: 'none', display: 'flex', alignItems: 'center', transition: 'opacity 0.3s ease' }}
              onMouseOver={(e) => e.target.style.opacity = '0.8'}
              onMouseOut={(e) => e.target.style.opacity = '1'}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.youtube.com/@srisaichaitanya5522" target="_blank" rel="noopener noreferrer" style={{ color: 'white', textDecoration: 'none', display: 'flex', alignItems: 'center', transition: 'opacity 0.3s ease' }}
              onMouseOver={(e) => e.target.style.opacity = '0.8'}
              onMouseOut={(e) => e.target.style.opacity = '1'}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <a href="tel:+91 8309440507" style={{ color: 'white', textDecoration: 'none', fontWeight: '500' }}>+91 8309440507</a>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          background: 'linear-gradient(135deg, #ac8484, #eb7932ff)',
          borderRadius: '12px',
          padding: '0.5rem',
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {/* <a href="https://wa.me/8309440507" target="_blank" rel="noopener noreferrer"
            ...
            <a href="https://www.instagram.com/srisaichaitanya_jr_college_mpl/" target="_blank" rel="noopener noreferrer"
              style={{ color: 'white', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0.35rem', borderRadius: '8px', transition: 'all 0.3s ease' }}
              onMouseOver={(e) => e.target.style.background = 'rgba(255,255,255,0.2)'}
              onMouseOut={(e) => e.target.style.background = 'transparent'}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.youtube.com/@srisaichaitanya5522" target="_blank" rel="noopener noreferrer"
              style={{ color: 'white', textDecoration: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0.35rem', borderRadius: '8px', transition: 'all 0.3s ease' }}
              onMouseOver={(e) => e.target.style.background = 'rgba(255,255,255,0.2)'}
              onMouseOut={(e) => e.target.style.background = 'transparent'}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="header-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', height: '75px' }}>
          ...
          >
            <div className="header-brand">
              <img
                src={logoImage}
                alt="Sai Chaitanya Junior College Logo"
