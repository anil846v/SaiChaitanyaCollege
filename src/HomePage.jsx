...
export default function HomePage() {
  ...
  <div className="homepage-container">
    ...
    <SEO
      title="Sai Chaitanya Junior College, Madanapalle | Best Intermediate College in Annamayya District"
      description="Sai Chaitanya Junior College is one of the best intermediate junior colleges in Madanapalle and Annamayya district, offering MPC, BiPC, MBiPC, MEC, and CEC with expert faculty, NEET & JEE coaching, and 19+ years of excellence."
      keywords="Sai Chaitanya Junior College, Sai Chaitanya Intermediate College, best junior college in Madanapalle, best intermediate college in Annamayya district, MPC BiPC college AP, NEET coaching Madanapalle, JEE coaching Annamayya, junior college near me"
